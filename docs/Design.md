# UI/UX 및 디자인 시스템 가이드 (Pinterest 기반)
...
- **Modal scrim** — a 50%-opacity dark overlay over the entire page content when the login modal opens, with a 16px ambient shadow under the modal card lifting it to the visual top.
